...
namespace ExcelLoadTestReport.RibbonCommands
{
    class RibbonCommands
    {
        ...
        public void ConditionalFormatting(int Min, int Max)
        {
        ...
        public void ConditionalFormattingMultiple(Single percentage)
        {
        ...
        public List<DAO.SelectedLoadTests> GetMyLoadTests(bool FilterByMe = true)
        {
        ...
        public List<DAO.SelectedLoadTests> GetLargeLoadTests(bool FilterByMe)
        {
            var _user = WindowsIdentity.GetCurrent();
            using (var ltDbContext = new Models.LoadTest2010Entities())
            {
        ...
        public List<DAO.SelectedLoadTests> GetHighSampleCountLoadTests(bool FilterByMe)
        {
            var _user = WindowsIdentity.GetCurrent();
            using (var ltDbContext = new Models.LoadTest2010Entities())
            {
        ...
        public List<DAO.SelectedLoadTests> GetSmallDurationLoadTests(bool FilterByMe)
        {
            var _user = WindowsIdentity.GetCurrent();
            using (var ltDbContext = new Models.LoadTest2010Entities())
            {
        ...
        public List<DAO.SelectedLoadTests> GetAllLoadTests(bool FilterByMe)
        {
            var _user = WindowsIdentity.GetCurrent();
            using (var ltDbContext = new Models.LoadTest2010Entities())
            {
        ...
        public void ToggleVisibility(bool hide, string sheettype)
        {
        ...
        public void DeleteTestsListedAsTransactions()
        {
